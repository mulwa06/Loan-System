...
def main():    
    ...
    Thank you for submitting your loan application on the {Timestamp} to [Your Company Name]. We have received your request and are currently in the process of reviewing the details.
