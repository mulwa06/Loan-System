...
def select_by_column(column, value):
    user_details = {'Timestamp':0, 'OFFICIAL NAME':1, 'AGE':2, 'SEX':3,\
        'GOVERNMENT ID NUMBER':4, 'photo':5, 'OCCUPATION':6, 'pay slip id':7, 'pay slip':8, 'LOAN DURATION':9,\
            'LOAN AMOUNT':10, 'MPESA NUMBER':11, 'EMAIL':12, 'APPLICATION ESSAY':13, "Status": 14, "Time of update": 15}  
